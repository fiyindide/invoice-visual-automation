...
#         self.type(self.ROW1_DESCRIPTION, description)
#         self.type(self.ROW1_QUANTITY, quantity)
#         self.type(self.ROW1_PRICE, price)
#         self.triggerUpdate()
#
#     def fillRow2(self, description, quantity, price):
#         self.type(self.ROW2_DESCRIPTION, description)
#         self.type(self.ROW2_QUANTITY, quantity)
#         self.type(self.ROW2_PRICE, price)
#         self.triggerUpdate()
#
